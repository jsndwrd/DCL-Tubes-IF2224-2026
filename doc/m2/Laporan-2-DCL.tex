...
\begin{itemize}
    \item file input: \texttt{test/milestone-2/input-1.txt} s.d. \texttt{test/milestone-2/input-7.txt}
    \item file output: \texttt{test/milestone-2/output-1.txt} s.d. \texttt{test/milestone-2/output-7.txt}
\end{itemize}
