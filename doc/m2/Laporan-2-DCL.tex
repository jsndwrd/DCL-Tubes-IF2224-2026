...
\begin{figure}[H]
    ...
    \vspace{0.3em}
    \begin{center}
        \textbf{Output 1} --- \texttt{test/milestone-2/output/output-1.png}
    \end{center}
    \vspace{0.3em}
...
\begin{figure}[H]
    ...
    \vspace{0.3em}
    \begin{center}
        \textbf{Output 2} --- \texttt{test/milestone-2/output/output-2.png}
    \end{center}
    \vspace{0.3em}
...
\begin{figure}[H]
    ...
    \vspace{0.3em}
    \begin{center}
        \textbf{Output 3} --- \texttt{test/milestone-2/output/output-3.png}
    \end{center}
    \vspace{0.3em}
...
\begin{figure}[H]
    ...
    \vspace{0.3em}
    \begin{center}
        \textbf{Output 4} --- \texttt{test/milestone-2/output/output-4.png}
    \end{center}
    \vspace{0.3em}
...
\begin{figure}[H]
    ...
    \vspace{0.3em}
    \begin{center}
        \textbf{Output 5} --- \texttt{test/milestone-2/output/output-5.png}
    \end{center}
    \vspace{0.3em}
...
\begin{figure}[H]
    ...
    \vspace{0.3em}
    \begin{center}
        \textbf{Output 6} --- \texttt{test/milestone-2/output/output-6.png}
    \end{center}
    \vspace{0.3em}
...
\begin{figure}[H]
    ...
    \vspace{0.3em}
    \begin{center}
        \textbf{Output 7} --- \texttt{test/milestone-2/output/output-7.png}
    \end{center}
    \vspace{0.3em}
